...
vim.o.mouse = '' -- Disable mouse (default: '')
...
vim.o.showtabline = 0 -- Never show native tabline (using lualine buffers instead)
...
--
--
--  In general for Neovim Lua config, the reference docs are:
--  - :h events — all autocmd events
--  - :h vim.o — all options
--  - :h vim.keymap.set — keymap API
--  - :h lua-guide — overview of the whole Lua API
