...
" ******************** Syntax *********************
" **************************************************
call s:SetHighlight('Boolean', s:green, '', '')
call s:SetHighlight('Delimiter', s:tan, '', '')
...
call s:SetHighlight('Constant', s:white, '', '')
call s:SetHighlight('Conditional', s:green, '', '')
...
call s:SetHighlight('TSTernary', s:cyan, '', '')
