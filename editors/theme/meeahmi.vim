...
call s:SetHighlight('PmenuSel', s:black, s:brightpink, s:bold)
...
" call s:SetHighlight("smlKeyChar", s:cyan, '', '')
" call s:SetHighlight("smlEncl", s:beige, '', '')
" call s:SetHighlight("smlFunction", s:beige, '', '')
call s:SetHighlight("smlBraceL", s:tan, '', '')
call s:SetHighlight("smlBraceR", s:tan, '', '')
call s:SetHighlight("smlBrackL", s:tan, '', '')
call s:SetHighlight("smlBrackR", s:tan, '', '')
call s:SetHighlight("smlParenL", s:tan, '', '')
call s:SetHighlight("smlParenR", s:tan, '', '')
call s:SetHighlight("smlComma", s:tan, '', '')
call s:SetHighlight("smlPeriod", s:tan, '', '')
call s:SetHighlight("smlSemicolon", s:tan, '', '')
call s:SetHighlight("smlEqual", s:cyan, '', '')
call s:SetHighlight("smlMapArrow", s:cyan, '', '')
call s:SetHighlight("smlCaretL", s:cyan, '', '')
call s:SetHighlight("smlCaretR", s:cyan, '', '')
call s:SetHighlight("smlDollar", s:cyan, '', '')
call s:SetHighlight("smlPlus", s:cyan, '', '')
call s:SetHighlight("smlMinus", s:cyan, '', '')
call s:SetHighlight("smlModulus", s:cyan, '', '')
call s:SetHighlight("smlOperator", s:cyan, '', '')
call s:SetHighlight("smlComment", s:midgray, '', s:italic) 
call s:SetHighlight("smlFunction", s:green, '', '')
